...
export async function generateMetadata(): Promise<Metadata> {
  const product = productPages.find((p) => p.slug === "duplex-vacuum-soap-plodder-machine");
...
export default function ProductPage() {
  ...
  return (
    <Layout>
      <JsonLd
        id="duplex-vacuum-soap-plodder-machine-product-schema"
        data={productSchema({
      ...
      />
      <JsonLd
        id="duplex-vacuum-soap-plodder-machine-breadcrumb-schema"
              ...
              {product.detailSection.images?.[0] && (
                <div className="overflow-hidden flex items-center justify-center">
                  <Image
                    ...
                    width={800}
                    height={500}
                    className="w-full max-w-[500px] max-h-[300px] shadow-xl"
                  />
                </div>
              )}
            ...
            <div className="grid md:grid-cols-2 gap-16">
              {product.configurations.map((config, i) => (
                <div key={i} className="text-center">
                  ...
                  />
                  <h3 className="text-xl font-medium text-primary leading-snug uppercase mb-2">
                    {config.title}
                  </h3>
