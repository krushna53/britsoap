...
export async function generateMetadata(): Promise<Metadata> {
  const product = productPages.find((p) => p.slug === "high-speed-soap-cutter-machine");
  ...
  return buildMetadata({
    ...
    path: "/high-speed-soap-cutter-machine",
  });
}
...
export default function ProductPage() {
  ...
  return (
    <Layout>
      <JsonLd
        id="high-speed-soap-cutter-machine-product-schema"
        data={productSchema({
      ...
      />
      <JsonLd
        id="high-speed-soap-cutter-machine-breadcrumb-schema"
        data={breadcrumbSchema([
          { name: "Home", path: "/" },
          { name: "Products", path: "/products" },
          { name: "High Speed Soap Cutter", path: "/high-speed-soap-cutter-machine" },
        ])}
      />
      <ProductHero
        title={product.title}
