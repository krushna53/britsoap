...
const featuredProducts = [
  { name: "Saponification Plant", image: "/images/product-saponification.jpg" },
  { name: "Drying Systems", image: "/images/product-drying.jpg" },
  { name: "Finishing Line", image: "/images/product-finishing.jpg" },
];
            ...
            >
              <div className="relative">
                <Image
                  ...
                  width={800}
                  height={500}
                  className="rounded w-full h-80 lg:h-[400px] object-cover"
                />
            ...
            {[
              {
                icon: Factory,
                title: "Plant Design",
                desc: "Complete soap plant design from saponification to packaging, tailored to your production needs.",
              },
              {
                icon: Cog,
                title: "Installation",
                desc: "On-site installation, commissioning, and startup support by our expert engineering team.",
              },
              {
                icon: Wrench,
                title: "After-Sales",
                desc: "Comprehensive maintenance, spare parts, and technical support for long-term reliability.",
              },
