...
const services = [
  {
    ...
    desc: "Custom-designed complete soap plants tailored to your production capacity, product range, and budget.",
  },
  {
    icon: Cog,
    title: "Equipment Manufacturing",
    desc: "Precision manufacturing using high-grade stainless steel and advanced fabrication techniques.",
  },
  {
    icon: Truck,
    title: "Installation & Commissioning",
    desc: "Expert on-site installation and commissioning ensuring your plant runs smoothly from day one.",
  },
  {
    icon: BarChart3,
    title: "Process Consultation",
    desc: "Technical consultation on soap formulations, process optimization, and production workflows.",
  },
  {
    icon: Wrench,
    title: "Maintenance & Spare Parts",
    desc: "Comprehensive maintenance programs and ready supply of genuine spare parts.",
  },
  {
    icon: Headphones,
    title: "After-Sales Support",
    desc: "Dedicated support team for troubleshooting, training, and technical guidance.",
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            },
            {
              step: "02",
              title: "Design",
              desc: "Custom plant design optimized for your needs.",
            },
            {
              step: "03",
              title: "Manufacturing",
              desc: "Precision manufacturing with strict QC.",
            },
            {
              step: "04",
              title: "Delivery",
              desc: "Installation, commissioning, and support.",
            },
          ].map((item, i) => (
            <motion.div
              key={item.step}
    ...
    <section className="py-20 bg-primary">
      <div className="container text-center">
        ...
        <p className="text-primary-foreground/60 max-w-md mx-auto mb-8 text-sm">
          Our engineering team is ready to design a solution for your specific
          requirements.
        </p>
        <Link
          href="/contact"
