...
const values = [
  {
    ...
    desc: "Precision-built machinery meeting international standards.",
  },
  {
    icon: Shield,
    title: "Durability & Strength",
    desc: "Built to last with robust materials and rigorous QC.",
  },
  {
    icon: Target,
    title: "Trust & Integrity",
    desc: "Transparent partnerships built on decades of reliability.",
  },
  {
    icon: Lightbulb,
    title: "Innovation",
    desc: "Continuously advancing technology for better performance.",
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    desc: "Tailored solutions designed around your requirements.",
  },
];
      ...
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            >
              A Joint Venture Built on Excellence
            </motion.h2>
            <motion.p
              variants={fadeUp}
              className="text-muted-foreground leading-relaxed mb-4 text-sm"
            >
              BritSoap Machinery Pvt. Ltd. is a joint venture between Britannia
              Soap Machinery Ltd of England and Orum Engineering Pvt Ltd of
              India. We combine British engineering expertise with Indian
            ...
            <motion.p
              ...
              className="text-muted-foreground leading-relaxed mb-4 text-sm"
            >
              We specialize in the design, manufacture, and installation of
              complete soap plants — from saponification to wrapping. Our
              commitment to quality and competitive pricing has made us a
            ...
            >
              With over 40 years of combined experience and installations in 25+
              countries, we set the standard in performance, reliability, and
              innovation.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              To deliver high-quality industrial machinery with precision
              engineering and global reliability.
            </p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 24 }}
          ...
          >
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              To provide end-to-end soap plant solutions with cutting-edge
              technology, competitive pricing, and unwavering customer
              satisfaction.
            </p>
          </motion.div>
        </div>
    ...
    <section className="py-20 bg-primary">
      <div className="container text-center">
        ...
        <p className="text-primary-foreground/60 max-w-md mx-auto mb-8 text-sm">
          Let's discuss how BritSoap can build your next soap manufacturing
          plant.
        </p>
        <Link
          href="/contact"
